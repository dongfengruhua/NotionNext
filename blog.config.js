...
const BLOG = {
  ...
  NOTION_PAGE_ID:
    ...
    '9304e4e7e22743eb9e2088353d9d2b5e,en:7c1d570661754c8fbc568e00a01fd70e',
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '鬼', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '一个普通的干饭人🍚', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || '', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '同济大学,同济网址导航', // 网站关键词 英文逗号隔开
  ...
  CONTACT_WEHCHAT_PUBLIC: process.env.NEXT_PUBLIC_CONTACT_WEHCHAT_PUBLIC || 'https://mp.weixin.qq.com/mp/profile_ext?action=home&__biz=【Mzg3Mzk3OTc0Nw】==#wechat_redirect', // 微信公众号 格式：https://mp.weixin.qq.com/mp/profile_ext?action=home&__biz=【Mzg3Mzk3OTc0Nw】==#wechat_redirect

  NOTION_HOST: process.env.NEXT_PUBLIC_NOTION_HOST || 'https://www.notion.so', // Notion域名，您可以选择用自己的域名进行反向代理，如果不懂得什么是反向代理，请勿修改此项

  BLOG_FAVICON: process.env.NEXT_PUBLIC_FAVICON || 'https://static.wetab.link/user-custom-icon/zh/6449515668ed50037ba7378b/user-custom-icon1gv0q1ibbqhu0m0x81rckrn2vnk.png?imageMogr2/thumbnail/176x/format/webp/blur/1x0/quality/100', // blog favicon 配置, 默认使用 /public/favicon.ico，支持在线图片，如 https://img.imesong.com/favicon.png
