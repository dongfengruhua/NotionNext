...
const BLOG = {
  ...
  NOTION_PAGE_ID:
    ...
    '9304e4e7e22743eb9e2088353d9d2b5e',
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '公众号：济你太美', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '一个普通的干饭人🍚', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || '', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '同济大学,网址导航', // 网站关键词 英文逗号隔开
  ...
  BLOG_FAVICON: process.env.NEXT_PUBLIC_FAVICON || 'https://wx.qlogo.cn/mmopen/ajNVdqHZLLCk5h1l6BsJiadmlJNSEJqtcURrQFby83vbqcoDnvicTGJumHrdKZ5zDZadqQ667ktqxlQkpJkj2yQo3fevXb3vRe7MLWCjHVvZ6J7kvU0RxVVxWuqzxdke3b/64', // blog favicon 配置, 默认使用 /public/favicon.ico，支持在线图片，如 https://img.imesong.com/favicon.png', // blog favicon 配置, 默认使用 /public/favicon.ico，支持在线图片，如 https://img.imesong.com/favicon.png
  ...
  BEI_AN: process.env.NEXT_PUBLIC_BEI_AN || '备案号 黔ICP备2024033948', // 备案号 闽ICP备XXXXXXX
